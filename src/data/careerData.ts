...
export const milestones: CareerMilestone[] = [
  ...
  },
  {
    ...
    narrative: "Then the theory ran out. My first real job put me on India's largest bank's core banking system — a platform where “let me try something” isn't an option, because the system doesn't sleep, neither do the consequences. Nothing in college prepares you for that weight. So I learned the way you actually learn: reading COBOL under pressure, tracing broken batches, working shifts through End-of-Year cycles where one mistake compounds across millions of accounts. Over four years I stopped being someone who knew about systems and became someone who knew this system — where it breaks, why it breaks, and what it costs when it does.",
    achievements: [
  ...
  },
  {
    ...
    skills: ["Linux", "SQL", "C++", "Python", "DBMS"],
    category: "frontend",
