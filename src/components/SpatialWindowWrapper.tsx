...
export default function SpatialWindowWrapper({
  ...
  return (
    <div
      ref={windowRef}
      onMouseDown={onFocus}
      className={`absolute rounded-3xl flex flex-col shadow-[0_32px_64px_rgba(0,0,0,0.7)] border transition-all duration-300 ${
        isActive 
    ...
    >
      ...
      <div 
        ...
        className="flex items-center justify-between px-6 py-4 border-b border-white/5 cursor-grab active:cursor-grabbing select-none"
      >
